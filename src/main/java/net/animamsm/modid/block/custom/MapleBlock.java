package net.animamsm.modid.block.custom;
...
public class MapleBlock extends TransparentBlock {
    ...
    public MapleBlock(AbstractBlock.Settings settings) {
        super(settings);
    }
    ...
    private static void addParticles(Entity entity, int count) {
        if (entity.getWorld().isClient) {
            BlockState blockState = ModBlocks.MAPLE_BLOCK.getDefaultState();
