...
;public enum ModArmorMaterial implements ArmorMaterial {
    MASAIAN("masaian", 40, new int[] {4,9,7,4},20,
            SoundEvents.ITEM_ARMOR_EQUIP_NETHERITE, 1f, 0.1f, () -> Ingredient.ofItems(ModItems.MASAIAN_CONDUIT))
    ;
    ...
    public String getName() {
        return AnimaMSM.MOD_ID + ":" + this.name;
    }
